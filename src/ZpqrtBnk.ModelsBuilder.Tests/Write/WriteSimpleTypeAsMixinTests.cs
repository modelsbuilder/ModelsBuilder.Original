...
{
    [TestFixture]
    public class WriteSimpleTypeAsMixinTests : TestsBase
    {
        ...
        private static SemanticModel GetSemanticModel(PropertyStyle propertyStyle, FallbackStyle fallbackStyle)
        {
        ...
        public void Property_Nothing()
        {
            ...
            symbols = semanticModel.LookupTypeSymbolMembers("Umbraco.Web.PublishedModels", "IType1");
            Assert.AreEqual(4, symbols.OfType<IPropertySymbol>().Count());
        }
