...
namespace Our.ModelsBuilder.Tests.DotNet
{
    ...
    public class AppDomainTests
    {
        ...
        public void Test()
        {
            ...
            var load = Path.Combine(bzzt, "Our.ModelsBuilder.Tests.dll"); // we want to load the copy!
            File.Copy("Our.ModelsBuilder.Tests.dll", load);
            ...
            File.Copy("Our.ModelsBuilder.dll", Path.Combine(bzzt, "Our.ModelsBuilder.dll")); // REQUIRED if we load copies
            ...
            var remote = domain.CreateInstanceFromAndUnwrap(load, "Our.ModelsBuilder.Tests.RemoteObject") as RemoteObject;
    ...
    public class RemoteObject : MarshalByRefObject
    {
        public IEnumerable<SharedObject> GetSharedObjects()
        {
            ...
            Assembly.Load("Our.ModelsBuilder");
