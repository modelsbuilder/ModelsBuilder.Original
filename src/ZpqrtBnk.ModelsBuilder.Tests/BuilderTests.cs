...
";
        ...
        public void GenerateSimpleTypeWithoutPropertiesWithFallbackFunc()
        {
            ...
            var parseResult = new CodeParser().Parse(code);
            parseResult.SetGenerateFallbackFuncExtensionMethods(true);
            var builder = new Builder(types, parseResult);
            var btypes = builder.AllTypeModels;
...
namespace Umbraco.Web.PublishedModels
{
	...
	public static partial class Type1Extensions
	{
		...
		public static string Prop1(this Type1 that, Func<Type1, string> fallback = default)
			=> that.Value<Type1, string>(""prop1"", fallback: fallback);
	}
...
[assembly:ModelsBuilderConfigure(TypeModelPrefix=""Xxx"", TypeModelSuffix=""Yyy"")]
"}
            };
