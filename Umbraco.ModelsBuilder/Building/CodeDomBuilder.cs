    ...
    internal class CodeDomBuilder : Builder
    {
        ...
        public void Generate(CodeNamespace ns, TypeModel typeModel)
        {
            ...
            if (typeModel.IsMixin)
            {
                ...
                i.Comments.Add(new CodeCommentStatement($"Mixin content type {typeModel.Key} with alias \"{typeModel.Alias}\""));
            ...
            c.Comments.Add(new CodeCommentStatement($"Content type {typeModel.Key} with alias \"{typeModel.Alias}\""));
