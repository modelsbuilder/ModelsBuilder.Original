...
namespace Umbraco.ModelsBuilder.PackageActions
{
    ...
    public class Configure : IPackageAction
    {
        ...
        {
            LogHelper.Debug<Configure>("Configure Umbraco.ModelsBuilder package.");
            ...
            if (add == null)
            {
                ...
                attr.Value = "Umbraco.ModelsBuilder.AspNet.ModelsBuildProvider, Umbraco.ModelsBuilder.AspNet";
                add.Attributes.Append(attr);
        ...
        {
            LogHelper.Debug<Configure>("Remove Umbraco.ModelsBuilder package.");
