...
namespace Zbu.ModelsBuilder.Console
{
    class Program
    {
        static void Usage()
        {
            SysConsole.WriteLine("Usage: Zbu.ModelsBuilder.Console [-d <directory>] [-ns <namespace>] <api>");
            ...
            SysConsole.WriteLine("Example: Zbu.ModelsBuilder.Console -d c:/models -ns My.Models http://john%40doe.com:1234@example.com");
        }

        static void Main(string[] args)
        {
            SysConsole.WriteLine("Zbu.ModelsBuilder v{0}", ApiVersion.Current.Version);
